...
public:
    ...
    AccessList get_access_list() const;
    ...
    void optimize_gas(AccessList& access_list, const evmc::address& from, const evmc::address& to, const evmc::address& coinbase);
  ...
  private:
    ...
    void optimize_warm_address_in_access_list(AccessList& access_list, const evmc::address& address);
