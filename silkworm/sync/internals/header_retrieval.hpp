...
class HeaderRetrieval {
  public:
    static const int soft_response_limit = 2 * 1024 * 1024;  // Target maximum size of returned blocks
    static const int est_header_rlp_size = 500;              // Approximate size of an RLP encoded block header
    static const int max_headers_serve = 1024;               // Amount of block headers to be fetched per retrieval request
