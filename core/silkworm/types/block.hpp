...
struct BlockHeader {
    ...
    [[nodiscard]] evmc::bytes32 hash(bool for_sealing = false, bool eip225 = false) const;
...
namespace rlp {
    ...
    void encode(Bytes& to, const BlockHeader&, bool for_sealing = false, bool eip225 = false);
