...
constexpr uint32_t BYTES_PER_LENGTH_OFFSET = 4;
...
constexpr unsigned int MIN_ATTESTATION_INCLUSION_DELAY = 1;

constexpr uint64_t MIN_GENESIS_ACTIVE_VALIDATOR_COUNT = 16384;
constexpr uint64_t MIN_GENESIS_TIME = 1606824000;
// const eth::Version GENESIS_FORK_VERSION{0x00000000};
constexpr uint64_t GENESIS_DELAY = 604800;
...
constexpr uint64_t SECONDS_PER_SLOT = 12;
constexpr uint64_t SECONDS_PER_ETH1_BLOCK = 14;
constexpr uint64_t MIN_VALIDATOR_WITHDRAWABILITY_DELAY = 256;
constexpr uint64_t SHARD_COMMITTEE_PERIOD = 256;
constexpr uint64_t ETH1_FOLLOW_DISTANCE = 2048;

// constexpr eth::Gwei EJECTION_BALANCE = 16000000000;
constexpr uint64_t MIN_PER_EPOCH_CHURN_LIMIT = 4;
constexpr uint64_t CHURN_LIMIT_QUOTIENT = 65536;
...
constexpr unsigned int MAX_COMMITTEES_PER_SLOT = 64;
constexpr unsigned int TARGET_COMMITTEE_SIZE = 128;
constexpr unsigned int MAX_VALIDATORS_PER_COMMITTEE = 2048;
constexpr unsigned int SHUFFLE_ROUND_COUNT = 90;
constexpr unsigned int HYSTERESIS_QUOTIENT = 4;
...
constexpr unsigned int SLOTS_PER_HISTORICAL_ROOT = 8192;
constexpr unsigned int MIN_EPOCHS_TO_INACTIVITY_PENALTY = 4;
constexpr unsigned int EPOCHS_PER_HISTORICAL_VECTOR = 65536;
constexpr unsigned int EPOCHS_PER_SLASHINGS_VECTOR = 8192;
...
constexpr unsigned int BASE_REWARD_FACTOR = 64;
constexpr unsigned int WHISTLEBLOWER_REWARD_QUOTIENT = 512;
constexpr unsigned int PROPOSER_REWARD_QUOTIENT = 8;
constexpr uint64_t INACTIVITY_PENALTY_QUOTIENT = 67108864;
constexpr unsigned int MIN_SLASHING_PENALTY_QUOTIENT = 128;
constexpr unsigned int PROPORTIONAL_SLASHING_MULTIPLIER = 1;
constexpr unsigned int MAX_PROPOSER_SLASHINGS = 16;
constexpr unsigned int MAX_ATTESTER_SLASHINGS = 2;
constexpr unsigned int MAX_ATTESTATIONS = 128;
constexpr unsigned int MAX_DEPOSITS = 16;
constexpr unsigned int MAX_VOLUNTARY_EXITS = 16;
...
constexpr unsigned int MAX_PUB_KEYS_PER_COMMITTEE = 512;
constexpr unsigned int MAX_LOGS_BLOOM = 256;

constexpr unsigned int kSyncCommitteeBranchSize{5};
constexpr unsigned int kFinalityBranchSize{6};

static constexpr uint64_t kCommiteeBitsSize{64};
