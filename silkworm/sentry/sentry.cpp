...
Task<void> SentryImpl::run_tasks() {
    ...
    try {
        ...
        if (se.code() == boost::system::errc::operation_canceled) {
            log::Warning("sentry") << "Sentry run_tasks unexpected end [operation_canceled]";
        } else {
...
Task<void> SentryImpl::run_peer_manager() {
    try {
        ...
        if (se.code() == boost::system::errc::operation_canceled) {
            log::Warning("sentry") << "run_peer_manager unexpected end [operation_canceled]";
        } else {
...
Task<void> SentryImpl::run_message_sender() {
    try {
        ...
        if (se.code() == boost::system::errc::operation_canceled) {
            log::Warning("sentry") << "run_message_sender unexpected end [operation_canceled]";
        } else {
...
Task<void> SentryImpl::run_message_receiver() {
    try {
        ...
        if (se.code() == boost::system::errc::operation_canceled) {
            log::Warning("sentry") << "run_message_receiver unexpected end [operation_canceled]";
        } else {
...
Task<void> SentryImpl::run_peer_manager_api() {
    try {
        ...
        if (se.code() == boost::system::errc::operation_canceled) {
            log::Warning("sentry") << "run_peer_manager_api unexpected end [operation_canceled]";
        } else {
...
Task<void> SentryImpl::run_peer_discovery_feedback() {
    try {
        ...
        if (se.code() == boost::system::errc::operation_canceled) {
            log::Warning("sentry") << "run_peer_discovery_feedback unexpected end [operation_canceled]";
        } else {
