...
class WebSocketConnection : public std::enable_shared_from_this<WebSocketConnection> {
  public:
    ...
    WebSocketConnection(boost::beast::websocket::stream<boost::beast::tcp_stream>&& ws,
                        RequestHandler&& request_handler);

    ~WebSocketConnection();

    template <class Body, class Allocator>
    Task<void> do_accept(boost::beast::http::request<Body, boost::beast::http::basic_fields<Allocator>> req);
    Task<void> do_read();
