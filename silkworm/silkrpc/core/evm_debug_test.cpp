...
TEST_CASE_METHOD(DebugExecutorTest, "DebugExecutor::execute call 1") {
    ...
    SECTION("Call: failed with intrinsic gas too low") {
        ...
        // TransactionDatabase::get_one: TABLE CanonicalHeader **** START *******
        static silkworm::Bytes kCanonicalHeaderKey2{*silkworm::from_hex("0000000000000000")};
        ...
        // TransactionDatabase::get_one: TABLE Config **** START *******
        static silkworm::Bytes kConfigKey1{*silkworm::from_hex("bf7e331f7f7c1dd2e05159666b3bf8bc7a8a3a9eb1d518969eab529dd9b88c1a")};
        static silkworm::Bytes kConfigValue1{*silkworm::from_hex("")};
        EXPECT_CALL(db_reader, get_one(db::table::kConfigName, silkworm::ByteView{kConfigKey1}))
            .WillOnce(InvokeWithoutArgs([]() -> boost::asio::awaitable<Bytes> {
                co_return kConfigValue1;
            }));
    ...
    SECTION("Call: full output") {
        ...
        // static silkworm::Bytes kTxSenderKey{*silkworm::from_hex("00000000005279a7c07964f1077d2856a353fceafefb64b8ec1bcbefec632b6ce3ddff3798f5b878")};
        // static silkworm::Bytes kTxSenderValue{*silkworm::from_hex("")};
        // EXPECT_CALL(db_reader, get_one(db::table::, silkworm::ByteView{}))
        //     .WillRepeatedly(InvokeWithoutArgs([]() -> boost::asio::awaitable<Bytes> {
        //         co_return ;
        //     }));

        // TransactionDatabase::get_one: TABLE CanonicalHeader **** START *******
        static silkworm::Bytes kCanonicalHeaderKey1{*silkworm::from_hex("0000000000000000")};
        static silkworm::Bytes kCanonicalHeaderValue1{*silkworm::from_hex("bf7e331f7f7c1dd2e05159666b3bf8bc7a8a3a9eb1d518969eab529dd9b88c1a")};
        EXPECT_CALL(db_reader, get_one(db::table::kCanonicalHashesName, silkworm::ByteView{kCanonicalHeaderKey1}))
            .WillRepeatedly(InvokeWithoutArgs([]() -> boost::asio::awaitable<Bytes> {
                co_return kCanonicalHeaderValue1;
            }));
        ...
        // TransactionDatabase::get: TABLE AccountHistory **** START *******
        // static silkworm::Bytes kAccountHistoryKey{*silkworm::from_hex("52728289eba496b6080d57d0250a90663a07e55600000000005279a8")};
        // static silkworm::Bytes kAccountHistoryValue{*silkworm::from_hex("0100000000000000000000003a300000020000007800000079000000180000001a00000078ebe403")};
        ...
        // TransactionDatabase::get_both_range: TABLE AccountChangeSet **** START *******
        static silkworm::Bytes kAccountChangeSetKey2{*silkworm::from_hex("000000000078eb78")};
        static silkworm::Bytes kAccountChangeSetSubkey2{*silkworm::from_hex("52728289eba496b6080d57d0250a90663a07e556")};
        static silkworm::Bytes kAccountChangeSetValue2{*silkworm::from_hex("03030933df0a24e426722d0b7126fdb8")};
        EXPECT_CALL(db_reader, get_both_range(db::table::kAccountChangeSetName, silkworm::ByteView{kAccountChangeSetKey2}, silkworm::ByteView{kAccountChangeSetSubkey2}))
            .WillOnce(InvokeWithoutArgs([]() -> boost::asio::awaitable<std::optional<Bytes>> {
                co_return kAccountChangeSetValue2;
