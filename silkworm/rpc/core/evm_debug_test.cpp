...
struct DebugExecutorTest : public test_util::ServiceContextTestBase {
    ...
    db::chain::Providers providers{ethdb::kv::block_provider(&backend), ethdb::kv::block_number_from_txn_hash_provider(&backend), ethdb::kv::block_number_from_block_hash_provider(&backend), ethdb::kv::block_hash_from_block_number_provider(&backend)};
