...
int main(int argc, char* argv[]) {
    ...
    auto benchmark_etl_buffer_unordered = app_main.add_subcommand("buffer_unordered", "List db and tables info");
    auto benchmark_etl_buffer_ordered = app_main.add_subcommand("buffer_ordered", "Print free pages info");
    /*
