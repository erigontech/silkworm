...
TEST_CASE("rpc_api io (individual)", "[silkrpc][rpc_api]") {
    ...
    SECTION("sample test") {
        auto request = R"({"id":1,"jsonrpc":"2.0","method":"eth_getTransactionReceipt","params":["0x0d9ba049a158972e7fc1066122ceb31e431483ebf84f90f845f02e326942d467"]})"_json;
        http::Reply reply;

        test_base.run<&RequestHandler_ForTest::request_and_create_reply>(request, reply);
        CHECK(nlohmann::json::parse(reply.content) == R"({"id":1,"jsonrpc":"2.0","result":{"blockHash":"0xfe21bb173f43067a9f90cfc59bbb6830a7a2929b5de4a61f372a9db28e87f9ae","blockNumber":"0x2","contractAddress":null,"cumulativeGasUsed":"0x5208","effectiveGasPrice":"0x2db08787","from":"0x658bdf435d810c91414ec09147daa6db62406379","gasUsed":"0x5208","logs":[],"logsBloom":"","status":"0x1","to":"0x658bdf435d810c91414ec09147daa6db62406379","transactionHash":"0x0d9ba049a158972e7fc1066122ceb31e431483ebf84f90f845f02e326942d467","transactionIndex":"0x0","type":"0x0"}})"_json);
    }
