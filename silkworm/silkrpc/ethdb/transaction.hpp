...
class Transaction {
  public:
    ...
    [[nodiscard]] virtual uint64_t view_id() = 0;
    ...
    virtual std::shared_ptr<silkworm::State> create_state(boost::asio::io_context& io_context, const core::rawdb::DatabaseReader& db_reader, uint64_t block_number) = 0;
