...
class TrieCursor {
  public:
    explicit TrieCursor(sw_mdbx::ROCursor& db_cursor, PrefixSet* changed, etl::Collector* collector = nullptr);
  ...
  private:
    ...
    sw_mdbx::ROCursor& db_cursor_;  // The underlying db cursor (TrieAccount/TrieStorage)
