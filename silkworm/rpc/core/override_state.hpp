...
class OverrideState : public silkworm::State {
  public:
    ...
    void unwind_state_changes(BlockNum block_number) override {
        inner_state_.unwind_state_changes(block_number);
    }
