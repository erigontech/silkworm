...
static void build_header_index(benchmark::State& state) {
    ...
    snapshot::SnapshotSettings settings{tmp_dir};
    snapshot::SnapshotRepository repository{settings};
    ...
    for ([[maybe_unused]] auto _ : state) {
        ...
        snapshot::HeaderIndex header_index{header_snapshot_path};
        header_index.build();
    }
}
...
static void build_body_index(benchmark::State& state) {
    ...
    for ([[maybe_unused]] auto _ : state) {
        ...
        snapshot::BodyIndex body_index{body_snapshot_path};
        body_index.build();
    }
}
...
static void build_tx_index(benchmark::State& state) {
    ...
    for ([[maybe_unused]] auto _ : state) {
        ...
        snapshot::TransactionIndex txn_index{txn_snapshot_path};
        txn_index.build();
    }
}
