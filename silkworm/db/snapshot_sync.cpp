...
Task<void> SnapshotSync::setup() {
    ...
    sw_mdbx::RWTxnManaged rw_txn = data_store_.chaindata.start_rw_tx();
...
void SnapshotSync::update_block_headers(RWTxn& txn, BlockNum max_block_available, const std::function<bool()>& is_stopping) {
    ...
    sw_mdbx::Collector hash_to_block_num_collector;
    ...
    sw_mdbx::PooledCursor header_numbers_cursor{txn, table::kHeaderNumbers};
