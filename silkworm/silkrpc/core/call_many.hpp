...
class CallExecutor {
  public:
    ...
    boost::asio::awaitable<CallManyResult> execute(const Bundles& bundles, const SimulationContext& context, std::optional<StateOverrides> state_overrides, std::optional<std::uint64_t> timeout);
