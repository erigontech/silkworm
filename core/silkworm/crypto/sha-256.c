...
static inline ALWAYS_INLINE void sha_256_implementation(uint32_t h[8], const void *input, size_t len) {
     ...
     * = 63 Note 3: The compression function uses 8 working variables, a through h Note 4: Big-endian convention is used
     * when expressing the constants in this pseudocode, and when parsing message block data from bytes to words, for
     * example, the first word of the input message "abc" after padding is 0x61626380
     */
