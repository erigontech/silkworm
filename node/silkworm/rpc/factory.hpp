...
class Factory {
  ...
  protected:
    ...
    Factory(typename CallHandlers::RequestRpcFunc request_rpc, std::size_t requestsInitialCapacity)
        : handlers_{
            {
    ...
    Factory(typename CallHandlers::RequestRpcFunc request_rpc)
        : Factory(request_rpc, kRequestsInitialCapacity) {}
