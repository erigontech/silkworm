...
#include <silkworm/node/snapshots/config/bor_mainnet.hpp>
#include <silkworm/node/snapshots/config/goerli.hpp>
#include <silkworm/node/snapshots/config/mainnet.hpp>
#include <silkworm/node/snapshots/config/mumbai.hpp>
#include <silkworm/node/snapshots/config/sepolia.hpp>
