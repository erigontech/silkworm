...
namespace internal {
    ...
    constexpr uint8_t kUnhexTable[256] = {
    ...
    constexpr uint8_t kUnhexTable4[256] = {
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    inline uint8_t unhex_lut(uint8_t x) { return kUnhexTable[x]; }
    inline uint8_t unhex_lut4(uint8_t x) { return kUnhexTable4[x]; }
}  // namespace internal
...
constexpr std::optional<Bytes> from_hex(std::string_view hex) noexcept {
    ...
    if (pos) {
        auto b{internal::unhex_lut(static_cast<uint8_t>(*src++))};
        if (b == 0xff) {
            return std::nullopt;
        }
        *dst++ = b;
    ...
    while (last - src >= 8) {
        auto a{internal::unhex_lut4(static_cast<uint8_t>(*src++))};
        auto b{internal::unhex_lut(static_cast<uint8_t>(*src++))};
        auto c{internal::unhex_lut4(static_cast<uint8_t>(*src++))};
        auto d{internal::unhex_lut(static_cast<uint8_t>(*src++))};
        auto e{internal::unhex_lut4(static_cast<uint8_t>(*src++))};
        auto f{internal::unhex_lut(static_cast<uint8_t>(*src++))};
        auto g{internal::unhex_lut4(static_cast<uint8_t>(*src++))};
        auto h{internal::unhex_lut(static_cast<uint8_t>(*src++))};
