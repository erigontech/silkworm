...
TEST_CASE("decode", "[rlp]") {
  ...
  SECTION("uint64") {
    ...
    CHECK_THROWS_MATCHES(decoded_uint64(unhex("8105"s)), DecodingError,
                         Message("non-canonical single byte"));
    CHECK_THROWS_MATCHES(decoded_uint64(unhex("8200F4"s)), DecodingError,
                         Message("leading zero(s)"));
    CHECK_THROWS_MATCHES(decoded_uint64(unhex("B8020004"s)), DecodingError,
                         Message("non-canonical size"));
    CHECK_THROWS_MATCHES(decoded_uint64(unhex("8AFFFFFFFFFFFFFFFFFF7C"s)), DecodingError,
  ...
  SECTION("uint256") {
    ...
    CHECK_THROWS_MATCHES(decoded_uint256(unhex("8105"s)), DecodingError,
                         Message("non-canonical single byte"));
    CHECK_THROWS_MATCHES(decoded_uint256(unhex("8200F4"s)), DecodingError,
                         Message("leading zero(s)"));
    CHECK_THROWS_MATCHES(decoded_uint256(unhex("B8020004"s)), DecodingError,
                         Message("non-canonical size"));
