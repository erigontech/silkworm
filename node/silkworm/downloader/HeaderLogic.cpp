...
// Node current status
BlockNum HeaderRetrieval::head_height() { return db_.stage_progress(db::stages::kBlockBodiesKey); }
...
std::tuple<Hash, BlockNum> HeaderRetrieval::get_ancestor(Hash hash, BlockNum blockNum, BlockNum ancestor,
