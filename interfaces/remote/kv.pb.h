...
class Cursor final :
 ...
 public:
  ...
  ~Cursor() override;
  explicit constexpr Cursor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class StorageChange final :
 ...
 public:
  ...
  explicit constexpr StorageChange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AccountChange final :
 ...
 public:
  ...
  explicit constexpr AccountChange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class StateChangeBatch final :
 ...
 public:
  ...
  explicit constexpr StateChangeBatch(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  uint64_t databaseviewid() const;
  void set_databaseviewid(uint64_t value);
  private:
  uint64_t _internal_databaseviewid() const;
  void _internal_set_databaseviewid(uint64_t value);
  public:
...
class StateChange final :
 ...
 public:
  ...
  explicit constexpr StateChange(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class StateChangeRequest final :
 ...
 public:
  ...
  explicit constexpr StateChangeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* Cursor::release_bucketname() {
  ...
  return bucketname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline uint64_t StateChangeBatch::_internal_databaseviewid() const {
  return databaseviewid_;
}
inline uint64_t StateChangeBatch::databaseviewid() const {
  // @@protoc_insertion_point(field_get:remote.StateChangeBatch.databaseViewID)
  return _internal_databaseviewid();
}
inline void StateChangeBatch::_internal_set_databaseviewid(uint64_t value) {
  
  databaseviewid_ = value;
}
inline void StateChangeBatch::set_databaseviewid(uint64_t value) {
