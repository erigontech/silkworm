...
#include <silkworm/node/downloader/messages/message.hpp>
...
class BlockExchange final : public ActiveComponent {
  public:
    ...
    void new_target_block(const Block&);  // set a new target block to download, to use with Target_Tracking::kExplicit
