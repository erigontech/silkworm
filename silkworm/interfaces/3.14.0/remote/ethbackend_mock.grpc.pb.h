...
class MockETHBACKENDStub : public ETHBACKEND::StubInterface {
 public:
  ...
  MOCK_METHOD3(EngineGetBlobsBundleV1, ::grpc::Status(::grpc::ClientContext* context, const ::remote::EngineGetBlobsBundleRequest& request, ::types::BlobsBundleV1* response));
  MOCK_METHOD3(AsyncEngineGetBlobsBundleV1Raw, ::grpc::ClientAsyncResponseReaderInterface< ::types::BlobsBundleV1>*(::grpc::ClientContext* context, const ::remote::EngineGetBlobsBundleRequest& request, ::grpc::CompletionQueue* cq));
  MOCK_METHOD3(PrepareAsyncEngineGetBlobsBundleV1Raw, ::grpc::ClientAsyncResponseReaderInterface< ::types::BlobsBundleV1>*(::grpc::ClientContext* context, const ::remote::EngineGetBlobsBundleRequest& request, ::grpc::CompletionQueue* cq));
