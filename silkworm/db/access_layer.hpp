...
class DataModel {
  public:
    ...
    std::pair<std::optional<BlockNum>, std::optional<TxnId>> read_tx_lookup(const evmc::bytes32& tx_hash) const;
  ...
  private:
    ...
    std::pair<std::optional<BlockNum>, std::optional<TxnId>> read_tx_lookup_from_db(const evmc::bytes32& tx_hash) const;
    std::pair<std::optional<BlockNum>, std::optional<TxnId>> read_tx_lookup_from_snapshot(const evmc::bytes32& tx_hash) const;
