...
class MockTransaction : public ethdb::Transaction {
  public:
    ...
    MOCK_METHOD((boost::asio::awaitable<std::shared_ptr<silkworm::State>>), get_state, (boost::asio::io_context& /* io_context */, const core::rawdb::DatabaseReader& /* db_reader */, uint64_t /* block_number */));
