...
TEST_CASE("KVSegmentFile") {
    ...
    static constexpr seg::CompressionKind compression_kind = seg::CompressionKind::kKeys;
    ...
    KVSegmentFileWriter file_writer{path, compression_kind, tmp_dir.path()};
    ...
    KVSegmentFileReader file_reader{path, compression_kind};
