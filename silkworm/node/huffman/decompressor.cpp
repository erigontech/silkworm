...
CodeWord::CodeWord(uint16_t code, uint8_t length, ByteView pattern, PatternTable* table, CodeWord* next)
    : code_(code), code_length_(length), pattern_(pattern), table_(table), next_(next) {}
