...
class DirectService : api_common::Service {
  public:
    ...
    boost::asio::awaitable<std::shared_ptr<common::Channel<api_common::MessageFromPeer>>> messages(api_common::MessageIdSet message_id_filter) override;
    ...
    boost::asio::awaitable<std::shared_ptr<common::Channel<api_common::PeerEvent>>> peer_events() override;
